...
Our website still looks like garbage. Let's add Tailwind so we can make it look not so bad. All these setup instructions were pulled from [tailwindcss.com](https://tailwindcss.com/).
